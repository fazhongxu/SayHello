...
public class TestCaseActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        mAdapter = new TestCaseAdapter(this, new ArrayList<>());
        mAdapter.setOnItemClickListener(new TestCaseAdapter.OnItemClickListener() {
            @Override
            public void onItemClicked(TestCaseEntity item) {
                Toast.makeText(TestCaseActivity.this, "Clicked: " + item.getTitle(), Toast.LENGTH_SHORT).show();
            }
        });
